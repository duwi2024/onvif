...
import (
	...
	"github.com/duwi2024/onvif/xsd/onvif"
)
...
type FilterType struct {
	TopicExpression TopicExpressionType  `xml:"tev:TopicExpression"`
	MessageContent  *QueryExpressionType `xml:"tev:MessageContent"`
}
