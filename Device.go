...
import (
	...
	"github.com/duwi2024/onvif/gosoap"
	"github.com/duwi2024/onvif/networking"
	wsdiscovery "github.com/duwi2024/onvif/ws-discovery"
)
...
func (dev *Device) SetUnEventSubscription(action string, to string) {
	dev.headerAction = &HeaderAction{
		MustUnderstand: "1",
		Value:          action,
	}
	dev.headerTo = &HeaderTo{
		MustUnderstand: "1",
		Value:          to,
	}
}
func (dev *Device) ClearUnEventSubscription() {
	dev.headerAction = nil
	dev.headerTo = nil
}

//func (dev *Device) GetUnEventSubscription() (string, string) {
//	action, to := "", ""
//	if dev.unEventSubscriptionAction != nil {
//		action = dev.unEventSubscriptionAction.Value
//	}
//	if dev.unEventSubscriptionTo != nil {
//		to = dev.unEventSubscriptionTo.Value
//	}
//	return string(action), string(to)
//}
...
func (dev Device) CallMethodWithEndpoint(method interface{}, endpoint string) (*http.Response, error) {
	return dev.callMethodDo(endpoint, method)
}
...
func (dev Device) callMethodDo(endpoint string, method interface{}) (*http.Response, error) {
	...
	if dev.headerAction != nil && dev.headerAction.Value != "" {
		soapReq, err := xml.MarshalIndent(dev.headerAction, "", "  ")
		if err != nil {
			panic(err)
		}
	...
	if dev.headerTo != nil && dev.headerTo.Value != "" {
		soapReq, err := xml.MarshalIndent(dev.headerTo, "", "  ")
		if err != nil {
			panic(err)
		}
		soap.AddStringHeaderContent(string(soapReq))
