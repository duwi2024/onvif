...
func NewSecurity(username, passwd string) Security {
	return newSecurity(username, passwd, time.Now().UTC())
}

func NewSecurityWithTime(username, passwd string, utcTime time.Time) Security {
	return newSecurity(username, passwd, utcTime)
}

func newSecurity(username, passwd string, utcTime time.Time) Security {
